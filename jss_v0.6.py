...
from tests_generator import generate_random_jss
...
for JOBS, MACHINES in [
    ...
    with open(f"tests4/instance{JOBS}_{MACHINES}.txt", "w") as file:
        file.write(out2)
    """
    # generate_random_jss(JOBS, MACHINES, 20, "tests4")
    # To open a file with jobs
    jobs_data = open_file(f"tests4/instance{JOBS}_{MACHINES}.txt")
    main(jobs_data)
