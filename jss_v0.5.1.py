...
def main(jobs_data, VERBOSE=False):
    ...
    while any(data_with_times):
        if VERBOSE and current_time % 1000 == 0:
...
for file_name in [
    "tests/instance5_5.txt",
    "tests/instance6_6.txt",
    "tests/instance7_7.txt",
    "tests/instance8_8.txt",
    "tests/instance9_9.txt",
    "tests/instance10_10.txt",
    "tests/instance15_15.txt",
    "tests/instance20_15.txt",
    "tests/instance20_25.txt",
    "tests/instance30_30.txt",
    "tests/instance100_30.txt",
    "tests/instance100_100.txt",
    "tests/instance200_200.txt",
    "tests/instance300_300.txt",
    "tests/instance1000_10.txt",
    "tests/instance1000_100.txt",
]:
